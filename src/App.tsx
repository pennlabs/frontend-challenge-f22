    ...
    return (
        ...
        >
            ...
            <div className='flex items-center w-full px-8 gap-4'>
                ...
                <input
                    className='w-full py-2 mx-auto my-8 border-b border-stone-400 focus:outline-none focus:border-stone-600'
            ...
            <div className='flex w-full'>
                <div className='text-stone-400'>
                    <p>Enter to search</p>
                    <p>Showing {courses.length} search results</p>
                </div>
                <div className='flex gap-4'>
                    ...
                    >
                        <span className={`inline-block p-4 rounded-md ${!isSemanticSearch && `bg-white hover:bg-transparent transition`}`}>Semantic search ✨</span>
                    </button>
                    <button
                        data-tooltip="Plain basic search, matches exactly what you type"
                        className={`${isSemanticSearch ? "text-stone-500 transition hover:bg-stone-500 hover:text-white" : "bg-stone-500 text-white"} border-2 border-stone-500 p-4 rounded-md`}
